...
INSTALLED_APPS = [
    ...
    'allauth.socialaccount.providers.yandex', # added for allauth
    'ckeditor', 
    'ckeditor_uploader',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request', #added for allouth use
            ],
        },
    },
]
...
# Authentificaton backend were added for allouth use purposes
